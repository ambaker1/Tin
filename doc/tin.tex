...
The command \cmdlink{tin uninstall} uninstalls packages by deleting corresponding package folders as named by \cmdlink{tin mkdir}. Returns blank if successful, or error if it was unsuccessful in uninstalling the package. 
