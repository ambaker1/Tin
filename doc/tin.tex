...
The command \cmdlink{tin autoadd} uses specifically formatted GitHub release tags corresponding to package versions to automatically add entries to the Tin List. Returns list of versions added.
\begin{syntax}
