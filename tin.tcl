...
namespace eval ::tin {
    ...
    namespace export install update upgrade depend; # Install packages
    namespace export require import; # Package loading utilities
    namespace export library mkdir build; # Package development utilities
...
proc ::tin::update {} {
    tin auto_add tin https://github.com/ambaker1/Tin install.tcl
    set version [tin upgrade tin [package present tin]]
    tin require tin -exact $version
}
...
proc ::tin::build {inFile outFile config} {
